...
Authenticator processing steps:
 ...
 1. If `usage` does not include `"sign"`, return CTAP2_ERR_X.
...
Authenticator processing steps:
 ...
 1. If `usage` does not include `"ecdh"`, return CTAP2_ERR_X.
 ...
 1. Verify that `keyHandle.mac == HMAC-SHA-256(macKey, ecdhePublicKey ||
